...
for tibetan in tibetan_All:
    ...
    elif tibetan_len is 7:
        tibetan_Att = {'前加字': tibetan[0], '上加字': tibetan[1], '基字': tibetan[2], '下加字': tibetan[3],
                       '再下加字': None, '元音': tibetan[4], '后加字': tibetan[5], '再后加字': tibetan[6]}
    else:
        tibetan_pile = []
        first = True
